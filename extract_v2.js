...
const videoPath = 'assets/v2.mp4';
const outputDir = 'assets';
const outputPattern = 'assets/v2_frame_%04d.jpg';
...
try {
    ...
    // Count frames
    const files = fs.readdirSync(outputDir).filter(f => f.startsWith('v2_frame_') && f.endsWith('.jpg'));
